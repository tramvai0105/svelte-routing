...
# <ins>Пояснение изменений</ins>

Данная версия содержит возможность вызова функции при смене адреса через кнопки навигации браузера.
Компонент роутера содержит пропсы delayFn, duration, delay. Первостепенная цель этих изменений сделать возможным
анимацию при смене страницы средствами JS.
